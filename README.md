...
- **Nginx 서버** 환경에서 웹 트래픽과 CPU 상태를 주기적으로 수집
...
<details>
<summary><h3>4️⃣ 분석 내용</h3></summary>
...
웹사이트의 성공(200), 리디렉션(304), 오류(404) 등 상태 코드별로 요청 수를 확인
